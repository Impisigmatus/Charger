...
В необходимом пространстве имен регистрируем наши именованные аргументы(Первым аргументом макроса идет наше перечисление, далее значение перечисления и последним тип параметра):
```
namespace Arguments {
